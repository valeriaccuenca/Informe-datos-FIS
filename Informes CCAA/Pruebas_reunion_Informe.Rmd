...
fig_2 <-  
  prevalencias %>%
  filter(nombre_ccaa == "España" | nombre_ccaa == "Andalucía") %>% 
...
fig_2 <-  
  rii %>%
  filter(fr=="sedentarismo", nombre_ccaa == "España" | nombre_ccaa == "Andalucía") %>% 
...
Código de prueba antes de los cambios definitivos (conservar por si falla algo y tenemos que  volver)
```{r, echo=F}
fig_2 <-  
  rii %>%
